...
from src.datasets import LOLDataModule, FSDDataModule, UIEBDataModule  # noqa: I900
from src.models import LitDimma  # noqa: I900

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--config", type=str, default="configs/UIEB/stage2/8shot-lol-ft.yaml")
    ...
    elif cfg.dataset.name == "UIEB":
        dm = UIEBDataModule(config=cfg.dataset)
